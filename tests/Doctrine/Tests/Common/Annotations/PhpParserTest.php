...
{    
    ...
    {
        $parser = new PhpParser();
        $class = new ReflectionClass(__NAMESPACE__ . '\Fixtures\ClassWithAliasedUseStatements');

        $this->assertEquals(array(
            'common'   => 'Doctrine\Tests\Common',
            'routeAnnotation'    => __NAMESPACE__ . '\Fixtures\Annotation\Route',
            'templateAnnotation' => __NAMESPACE__ . '\Fixtures\Annotation\Template',
        ), $parser->parseClass($class));
    }
