...
DOCBLOCK;
    ...
    public function testIndexedByClass()
    {
        $parser = $this->createTestParser();
...
DOCBLOCK;
        ...
        $annot = $result['Doctrine\Tests\Common\Annotations\Marker'];
        $this->assertInstanceOf('Doctrine\Tests\Common\Annotations\Marker', $annot);
    }
